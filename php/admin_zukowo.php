    ...
    if(isset($_POST['przycisk']))
    {
        ...
        if($rok=='2021'){
            if($prc_7_21<0){
                ...
                WHERE miejscowosc='Zukowo' AND rok='2021'";
            ...
            if($prc_7_20<0){
                ...
                WHERE miejscowosc='Zukowo' AND rok='2020'";
            ...
            if($prc_7_19<0){
                ...
                WHERE miejscowosc='Zukowo' AND rok='2019'";
            ...
            if($prc_7_18<0){
                ...
                WHERE miejscowosc='Zukowo' AND rok='2018'";
    ...
    <div id="tabelka">
     <form method="POST" action="">
      ...
      <div id="2021">
        ...
        $sql= "SELECT miejscowosc, prc_1, prc_2, prc_3, prc_4, prc_5, prc_6, prc_7, budzet_zmienna FROM procenty WHERE miejscowosc='Zukowo' AND rok='2021'";
      ...
      <div id="2020" style="display: none">
        ...
        $sql= "SELECT miejscowosc, prc_1, prc_2, prc_3, prc_4, prc_5, prc_6, prc_7, budzet_zmienna from procenty Where miejscowosc='Zukowo' AND rok='2020'";
        $result = $conn-> query($sql);
      ...
      <div id="2019" style="display: none">
        ...
        $sql= "SELECT miejscowosc, prc_1, prc_2, prc_3, prc_4, prc_5, prc_6, prc_7, budzet_zmienna from procenty Where miejscowosc='Zukowo' AND rok='2019'";
        $result = $conn-> query($sql);
      ...
      <div id="2018" style="display: none">
        ...
        $sql= "SELECT miejscowosc, prc_1, prc_2, prc_3, prc_4, prc_5, prc_6, prc_7, budzet_zmienna from procenty Where miejscowosc='Zukowo' AND rok='2018'";
        $result = $conn-> query($sql);
    ...
    <!--============Zapisz i rok-->
      <table id="zapisz_tabelka">
        ...
        <tr>
            ...
            <td><input type="checkbox" id="oprocentowanie" name="oprocentowanie" onchange="checker()" checked></td>
